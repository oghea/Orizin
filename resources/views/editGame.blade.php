            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('update.game',$game_id->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('game_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="game_name" type="text" class="form-control" name="game_name" value="{{ $game_id->game_name }}">
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control" name="price" value="{{ $game_id->price }}">
                            ...
                            <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" class="form-control" type="date" name="date" value="{{ $game_id->date }}">
